...
Original data is in good quality at the start, but we need to preprocess it to suit our needs. In this section we want to describe how we prepared ready-to-use `csv`s of the train and test data (`train.csv`, `test_csv`). This includes variable transformations, joining external data, records processing.
